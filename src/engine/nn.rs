...
#[cfg(test)]
mod tests {
    use crate::engine::activation::Sigmoid;
    use crate::engine::activation::SoftMax;
    use crate::engine::activation::HyperbolicTangent;
    use crate::engine::sample::Sample;
    use crate::engine::nl::NeuralLayer;
    use crate::engine::nn::NeuralNetwork;
    use crate::engine::matrix::MatrixTrait;
    use crate::engine::cost::cross_entropy::CrossEntropy;
    use crate::engine::nn::BlackBox;
